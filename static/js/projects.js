    ...
    const projects = [
        {
            ...
            title: "Надо переделать, чтобы ширина была норм ну и стили мб как то, функционал рабчий",
        ...
        },
        {
            ...
            title: "Надо переделать, чтобы ширина была норм ну и стили мб как то, функционал рабчий",
            description: "Полная установка климатического оборудования в частном доме, интеграция с системой умного дома."
        }
    ];
